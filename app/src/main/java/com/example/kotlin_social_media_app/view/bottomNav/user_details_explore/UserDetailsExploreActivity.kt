...
@AndroidEntryPoint
class UserDetailsExploreActivity : AppCompatActivity(), ExploreAdapter.OnItemClickListener {
    //
    ...
    private fun initExploreRecyclerView() {
        ...
        recyclerViewUserDetailsLayout.apply {
            layoutManager = GridLayoutManager(this@UserDetailsExploreActivity, 3)

            exploreAdapter = ExploreAdapter(this@UserDetailsExploreActivity)
